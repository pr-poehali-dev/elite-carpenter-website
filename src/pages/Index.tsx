...
const SERVICES = [
  ...
  { icon: "CloudRain", title: "Кровельные работы", desc: "Монтаж и ремонт кровли: металлочерепица, профнастил, мягкая кровля, ондулин. Стропильные системы под ключ", price: "от 1 500 ₽/м²" },
  { icon: "ParkingSquare", title: "Навесы", desc: "Навесы для автомобилей, дров, техники и входных групп. Деревянный каркас, поликарбонат или металлочерепица", price: "от 60 000 ₽" },
];
